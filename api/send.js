...
module.exports = async function handler(req, res) {
  ...
  try {
    await resend.emails.send({
      from: 'noreply@culturalturkey.com',
      to: 'Reservation@alantatour.com',
      reply_to: email,
        ...
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
          ...
          <div style="background:#faf8f4;padding:32px;">
            <table style="width:100%;border-collapse:collapse;">
              <tr>
                <td style="padding:10px 0;border-bottom:1px solid #e8e0d4;color:#8a7355;font-size:11px;letter-spacing:1px;text-transform:uppercase;width:140px;">Name</td>
                <td style="padding:10px 0;border-bottom:1px solid #e8e0d4;color:#1a1510;font-size:14px;">${name}</td>
              </tr>
              <tr>
                <td style="padding:10px 0;border-bottom:1px solid #e8e0d4;color:#8a7355;font-size:11px;letter-spacing:1px;text-transform:uppercase;">Email</td>
                <td style="padding:10px 0;border-bottom:1px solid #e8e0d4;font-size:14px;"><a href="mailto:${email}" style="color:#c8a05a;">${email}</a></td>
              </tr>
              <tr>
                <td style="padding:10px 0;border-bottom:1px solid #e8e0d4;color:#8a7355;font-size:11px;letter-spacing:1px;text-transform:uppercase;">Phone</td>
                <td style="padding:10px 0;border-bottom:1px solid #e8e0d4;color:#1a1510;font-size:14px;">${phone || '—'}</td>
              </tr>
              <tr>
                <td style="padding:10px 0;border-bottom:1px solid #e8e0d4;color:#8a7355;font-size:11px;letter-spacing:1px;text-transform:uppercase;">Destination</td>
                <td style="padding:10px 0;border-bottom:1px solid #e8e0d4;color:#1a1510;font-size:14px;">${destination || '—'}</td>
              </tr>
              <tr>
                <td style="padding:10px 0;color:#8a7355;font-size:11px;letter-spacing:1px;text-transform:uppercase;vertical-align:top;">Message</td>
          ...
          <div style="background:#1a1510;padding:16px 32px;text-align:center;">
            <p style="color:rgba(240,232,216,0.4);font-size:11px;margin:0;">
